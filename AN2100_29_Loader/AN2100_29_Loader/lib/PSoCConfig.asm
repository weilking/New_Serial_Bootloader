...
export LoadConfig_AN2100_29_Loader
export _LoadConfig_AN2100_29_Loader
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_AN2100_29_Loader
	lcall	LoadConfigTBL_AN2100_29_Loader_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration AN2100_29_Loader
;
;    Load configuration registers for AN2100_29_Loader.
...
;               CUR_PP
;
_LoadConfig_AN2100_29_Loader:
 LoadConfig_AN2100_29_Loader:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_AN2100_29_Loader_Bank0
    mov     X, <LoadConfigTBL_AN2100_29_Loader_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_AN2100_29_Loader_Bank1
    mov     X, <LoadConfigTBL_AN2100_29_Loader_Bank1
